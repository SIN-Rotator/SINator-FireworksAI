...
echo "Installing SIN-Hermes-Provider-Bundle (Pool 2)..."

# 1. Provider Config
curl -fsSL "$REPO/config/fireworks-pool2.yaml" -o "$HERMES_HOME/config.yaml"
...
echo ""
echo "Pool 2 configured: sinatorpool2.delqhi.com"
echo ""
echo "Setup:"
