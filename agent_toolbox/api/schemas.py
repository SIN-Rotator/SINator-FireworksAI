...
class PoolStatsResponse(BaseModel):
    ...
    active_in_use: int = Field(default=0, description="Keys mit aktiven Agent-Consumern")
    available: int = Field(..., description="Verfügbare Keys (exkl. used, suspended, leased, active_in_use)")
