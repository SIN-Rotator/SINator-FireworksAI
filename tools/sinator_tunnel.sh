#!/bin/bash
# Cloudflare Tunnel Wrapper — Named Tunnel sinator.delqhi.com → localhost:8100
set -e
...
echo "Starting Cloudflare Named Tunnel sinator → sinator.delqhi.com → localhost:8100" | tee "$TUNNEL_LOG"
